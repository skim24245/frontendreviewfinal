...
//없는 요소의 값을 대입하면 새로운 요소가 추가된다.
// const arr3 =["A","B","C"];//0,1,2 위치 
// arr3[3]="D";
// console.log(arr3);

//push 메소드를 사용하면 요소를 배열 끝에 추가할 수 있다.
// const arr4= ["A","B","C","D"];
// arr4.push("E"); //맨 마지막에 추가된 것을 확인할 수 잇다.
// console.log(arr4);
// console.log(arr4.length);

// const arr4= ["A","B","C","D"];
// delete arr4[1]; //맨 마지막에 추가된 것을 확인할 수 잇다.
// console.log(arr4);
// console.log(arr4.length);
...
//destruturing 활용 json 파싱
const news = [
    {
        "title" :"sbs",
        "imgural":"http://static.naver.net/newsstand/2017/0313/article_img/9054/173200/001.jpg",
        "newslist":[
